...
class PreferencesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Preferences entity")
        ...
        .repeat(2) {
            ...
            .put("/api/preferencess")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "preferred_from":"2020-01-01T00:00:00.000Z", "preferred_to":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_preferences_url")))
            .pause(10)
            .repeat(5) {
