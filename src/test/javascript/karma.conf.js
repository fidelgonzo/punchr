...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/jquery-ui/ui/jquery-ui.js',
            'main/webapp/bower_components/fullcalendar/fullcalendar.js',
            ...
            'main/webapp/angulr/js/**/*.js',
            'main/webapp/angulr/templates/**/*.{js,html}',
