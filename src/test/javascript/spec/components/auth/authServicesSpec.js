...
describe('Services Tests', function () {
    ...
    describe('Auth', function () {
        ...
        beforeEach(inject(function($injector, localStorageService, Auth, AuthServerProvider) {
            ...
            $httpBackend.expectGET('angulr/templates/layout.html').respond({});
            $httpBackend.expectGET('angulr/templates/apps_note.html').respond({});
            $httpBackend.expectGET('angulr/templates/page_signin.html').respond({});
